...
<model-viewer loading="eager" id="reveal" camera-controls camera-orbit="0deg 90deg 75%" autoplay animation-name="Take 001" ar shadow-intensity="1" src="Models/Bank_Vault.glb" id="model-viewer" ar="" ar-modes="scene-viewer webxr quick-look" ios-src="Models/Bank_Vault.reality" alt="Challenge Demo" auto-rotate-delay="0" ar-scale="auto" style="width: 95%; height: 400px" ><button slot="ar-button" style="background-color: white; border-radius: 8px; border: 1 px solid black; position: absolute; top: 20px; right: 20px; ">
      👋 AR Click Here
  </button>
</model-viewer>
